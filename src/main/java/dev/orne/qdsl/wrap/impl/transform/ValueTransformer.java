...
/**
 * Functional interface for value transformation methods.
 * 
...
extends Function<S, T> {
    ...
    ValueTransformer<String, Byte> STR_TO_BYTE = s -> s == null ? null : Byte.valueOf(s);
    /** Value translator from {@code String} to {@code Short}. */
    ValueTransformer<String, Short> STR_TO_SHORT = s -> s == null ? null : Short.valueOf(s);
    /** Value translator from {@code String} to {@code Integer}. */
    ValueTransformer<String, Integer> STR_TO_INT = s -> s == null ? null : Integer.valueOf(s);
    /** Value translator from {@code String} to {@code Long}. */
    ValueTransformer<String, Long> STR_TO_LONG = s -> s == null ? null : Long.valueOf(s);
    /** Value translator from {@code String} to {@code Float}. */
    ValueTransformer<String, Float> STR_TO_FLOAT = s -> s == null ? null : Float.valueOf(s);
    /** Value translator from {@code String} to {@code Double}. */
    ValueTransformer<String, Double> STR_TO_DOUBLE = s -> s == null ? null : Double.valueOf(s);
    /** Value translator from {@code String} to {@code BigInteger}. */
    ValueTransformer<String, BigInteger> STR_TO_BIG_INT = s -> s == null ? null : new BigInteger(s);
    /** Value translator from {@code String} to {@code BigDecimal}. */
    ValueTransformer<String, BigDecimal> STR_TO_BIG_DEC = s -> s == null ? null : new BigDecimal(s);
    /** Value translator from {@code Number} to {@code String}. */
    ValueTransformer<Number, String> NUMBER_TO_STR = n -> n == null ? null : n.toString();
    /** Value translator from {@code String} to {@code Boolean}. */
    ValueTransformer<String, Boolean> STR_TO_BOOL = stringToBoolean("true");
    /** Value translator from {@code Boolean} to {@code String}. */
    ValueTransformer<Boolean, String> BOOL_TO_STR = booleanToString("true", "false");
     ...
     */
    static <T> ValueTransformer<T, T> identity() {
        return e -> e;
    }
     ...
     */
    static ValueTransformer<String, Boolean> stringToBoolean(
     ...
     * @return The created value translator
     */
    static ValueTransformer<Boolean, String> booleanToString(
            final @NotNull String trueValue,
     ...
     * @return The created value translator
     */
    static <S, T> ValueTransformer<S, T> beanUtilsBased(
