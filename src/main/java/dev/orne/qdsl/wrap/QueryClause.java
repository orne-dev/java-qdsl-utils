...
/**
 * Extension of {@code FetchableQuery} returned by {@code }.
 * Provides an additional method to convert the query to a sub query expression.
 * 
...
public interface QueryClause<T, C extends QueryClause<T, C>>
extends FetchableQuery<T, C> {
     ...
     */
    @Override
    <U> @NotNull QueryClause<U, ?> select(
     ...
     */
    @Override
    @NotNull QueryClause<Tuple, ?> select(
