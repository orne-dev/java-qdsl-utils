 ...
 * @since 0.1
 */
public class ValueStoreClause<V> {
     ...
     */
    public static @NotNull <V> ValueStoreClause<V> of(
            final @NotNull Path<V> path,
            final V value) {
    ...
    public static @NotNull <V> ValueStoreClause<V> of(
            final @NotNull Path<V> path,
            final Expression<? extends V> value) {
        return new ValueStoreClause<>(path, value);
    }
    ...
    public static <T> ValueStoreClause<T> ofUntyped(
     ...
     */
    public <R, C> R accept(
            final @NotNull ValueStoreClauseVisitor<R, C> visitor,
            final C context) {
    ...
    public boolean equals(final Object obj) {
        ...
        final ValueStoreClause<?> other = (ValueStoreClause<?>) obj;
