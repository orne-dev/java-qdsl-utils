 ...
 * @version 1.0, 2021-11
 * @since 0.1
 * @see TranslateVisitor
 */
@Tag("ut")
class TranslateVisitorTest {
    ...
    /**
     * Tests for {@link TranslateVisitor#visit(Constant, Context)}.
     */
    @Nested
    ...
    class ForConstant {
        ...
        /**
         * Test for {@link TranslateVisitor#visit(Constant, Context)}.
         */
        @Test
        @DisplayName("returns same Constant")
        void returnsSame() {
            final TranslateVisitor<?> visitor = spy(TranslateVisitor.class);
    ...
    /**
     * Tests for {@link TranslateVisitor#visit(FactoryExpression, Context)}.
     */
    @Nested
    ...
    class ForFactoryExpression {
        ...
        class WhenArgumentsRemain {
            ...
            /**
             * Test for {@link TranslateVisitor#visit(FactoryExpression, Context)}.
             */
            @Test
    ...
    /**
     * Tests for {@link TranslateVisitor#visit(Operation, Context)}.
     */
    @Nested
    ...
    class ForOperation {
        ...
        class WhenArgumentsRemain {
            ...
            /**
             * Test for {@link TranslateVisitor#visit(Operation, Context)}.
             */
            @Test
    ...
    /**
     * Tests for {@link TranslateVisitor#visit(ParamExpression, Context)}.
     */
    @Nested
    ...
    class ForParamExpression {
        ...
        /**
         * Test for {@link TranslateVisitor#visit(ParamExpression, Context)}.
         */
        @Test
    ...
    /**
     * Tests for {@link TranslateVisitor#visit(Path, Context)}.
     */
    @Nested
    ...
    class ForPath {
        ...
        class WithNoParent {
            ...
            /**
             * Test for {@link TranslateVisitor#visit(Path, Context)}.
             */
            @Test
    ...
    /**
     * Tests for {@link TranslateVisitor#visit(TemplateExpression, Context)}.
     */
    @Nested
    ...
    class ForTemplateExpression {
        ...
        class WhenArgumentsRemain {
            ...
            /**
             * Test for {@link TranslateVisitor#visit(TemplateExpression, Context)}.
             */
            @Test
    ...
    /**
     * Tests for {@link TranslateVisitor#visit(SubQueryExpression, Context)}.
     */
    @Nested
    ...
    class ForSubQueryExpression {
        ...
        class WhenComponentsRemain {
            ...
            /**
             * Test for {@link TranslateVisitor#visit(SubQueryExpression, Context)}.
             */
            @Test
        ...
        void willPreserveAllComponents(
                ...
                final TranslateVisitor<?> visitor) {
            willPreserveQueryFlags(metadata, visitor);
            willPreserveGroupByExpressions(metadata, visitor);
            willPreserveHaving(metadata, visitor);
            willPreserveJoinExpressions(metadata, visitor);
    ...
    /**
     * Tests for {@link TranslateVisitor#visit(OrderSpecifier, Context)}.
     */
    @Nested
    ...
    class ForOrderSpecifier {
        ...
        class WhenTargetRemains {
            ...
            /**
             * Test for {@link TranslateVisitor#visit(OrderSpecifier, Context)}.
             */
            @Test
    ...
    /**
     * Tests for {@link TranslateVisitor#visit(ValueAssignment, Context)}.
     */
    @Nested
    @DisplayName("when visiting a ValueAssignment")
    class ForValueAssignment {
        ...
        class WhenPathAndValueRemain {
            ...
            /**
             * Test for {@link TranslateVisitor#visit(ValueAssignment, Context)}.
             */
            @Test
            ...
            void returnsSameFor() {
                ...
                final ValueAssignment<?> value = ValueAssignment.of(path, valueExpr);
                willReturn(path).given(path).accept(visitor, null);
                willReturn(valueExpr).given(valueExpr).accept(visitor, null);
                final ValueAssignments result = visitor.visit(value, null);
                assertNotNull(result);
                assertEquals(1, result.size());
        ...
        class WhenPathChanges {
            ...
            void returnsAdapter() {
                final TranslateVisitor<?> visitor = spy(TranslateVisitor.class);
                final ValueAssignment<?> value = generateValueAssignment();
        ...
        class WhenPathTranslationIsNotPath {
            ...
            void returnsAdapter() {
                ...
                willReturn(newPath).given(path).accept(visitor, null);
                willReturn(valueExpr).given(valueExpr).accept(visitor, null);
                assertThrows(IllegalArgumentException.class, () -> visitor.visit(value, null));
                then(visitor).should().visit(value, null);
                then(visitor).shouldHaveNoMoreInteractions();
                then(path).should().accept(visitor, null);
                then(path).shouldHaveNoMoreInteractions();
    ...
    @SuppressWarnings("unchecked")
    ValueAssignment<?> generateValueAssignment() {
        final Path<MyType> path = mock(Path.class);
        final Expression<MyType> value = mock(Expression.class);
        return ValueAssignment.of(path, value);
    }

    ValueAssignments generateValueAssignments() {
        return generateValueAssignments(RandomUtils.nextInt(1, 10));
    }

    ValueAssignments generateValueAssignments(final int count) {
